...
extern void setServerCert(sqlite3 *ptr, int serverID, int counter, int trustFlag, char *cert, char *digest);
...
extern void updateServerDetails(sqlite3 *ptr, int srvID, const gchar *newDesc, const gchar *newUrl, const gchar *newUser, const gchar *newPw, gboolean resSel, gboolean certSel);
