...
extern void dbFlagDel(sqlite3 *ptr, char *table, char *flagCol, char *selCol, int selId, int flag);
...
extern void updateServerDetails(sqlite3 *ptr, int srvID, const gchar *newDesc, const gchar *newUrl, const gchar *newUser, const gchar *newPw, gboolean certSel, gboolean syncSel, gboolean safePasswd, char *newColor);
...
extern void exportContactsCB(sqlite3 *ptr, char *base, int type, int sel);
